...
const Card2 = () => {
  return (
    <div className="lg:absolute  lg:left-1/2 transform  lg:-translate-x-1/2 lg:-translate-y-1/2 translate-x-10 font-sans bg-gradient-to-r from-mainGreen to-secondaryGreen text-white rounded-md shadow-lg p-8 xl:w-11/12 w-full h-max z-50 mt-60 lg:mt-0 overflow-x-clip">
      <div className="lg:grid lg:grid-cols-3 lg:pl-0 lg:px-0 px-5 flex flex-col text-black ">
        <div className="col-span-1 flex flex-col justify-center">
          <h4 className="text-xl font-medium uppercase lg:block hidden">ENJOY ENCHANCED</h4>
          <h4 className="text-tiny font-medium uppercase lg:hidden block">Revolutionize <br></br> the e-commerce</h4>
          <h2 className="lg:text-5xl text-3.75xl font-semibold uppercase font-blanka ">
            Mission and goals
          </h2>
        </div>
