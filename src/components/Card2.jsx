...
const Card2 = () => {
  return (
    <div className="flex justify-end lg:justify-center">
      <div className="lg:relative font-sans bg-gradient-to-r from-mainGreen to-secondaryGreen text-white rounded-md shadow-lg p-8 w-10/12 h-max z-50 mt-0 overflow-x-clip">
